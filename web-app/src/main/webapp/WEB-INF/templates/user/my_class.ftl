                    ...
                    <table class="table table-striped" id="myClassTable">
                        ...
                        <#list courses! as course >
                            <#assign i=i+1>
                               <tr>
                                   <th scope="row">${i}</th>
                                   <td><a href="/user/classMes?id=${(course.CLASSID)!''}" >${(course.TITLE)!''}</a></td>
                                   <td>
                                   ...
                                   <td>
                                       <button type="button" class="btn btn-danger"><a href="/user/deleteClass?id=${(course.CLASSID)!}" style="color: white;">移除</a> </button>
